...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
  ...
  function srcAppAppComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    AppComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      ...
      decls: 4,
      vars: 0,
      consts: [[1, "split", "left"], [1, "split", "right"]],
  ...
  function srcAppAppModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    (function () {
      (typeof ngJitMode === "undefined" || ngJitMode) && _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵsetNgModuleScope"](AppModule, {
        declarations: [_app_component__WEBPACK_IMPORTED_MODULE_4__["AppComponent"], _list_list_component__WEBPACK_IMPORTED_MODULE_5__["ListComponent"], _edit_edit_component__WEBPACK_IMPORTED_MODULE_6__["EditComponent"], _preview_preview_component__WEBPACK_IMPORTED_MODULE_8__["PreviewComponent"]],
        imports: [_angular_platform_browser__WEBPACK_IMPORTED_MODULE_0__["BrowserModule"], _app_routing_module__WEBPACK_IMPORTED_MODULE_3__["AppRoutingModule"], _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpClientModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_7__["FormsModule"]]
      });
    })();
    /*@__PURE__*/
    ...
    var BlogService = /*#__PURE__*/function () {
      ...
      _createClass(BlogService, [{
        ...
        value: function newPost(username, post) {
          ...
          var url = "/api/".concat(username, "/").concat(postid);
          return this.http.post(url, post).toPromise()["catch"](this.handleError);
        }
      }, {
        key: "updatePost",
        value: function updatePost(username, post) {
          var postid = post.postid;
          var url = "/api/".concat(username, "/").concat(postid);
          return this.http.put(url, post).toPromise()["catch"](this.handleError);
        }
      }, {
        key: "deletePost",
  ...
  function srcAppEditEditComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    function EditComponent_div_0_Template(rf, ctx) {
      if (rf & 1) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function EditComponent_div_0_Template_button_click_19_listener() {
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r2);
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function EditComponent_div_0_Template_button_click_21_listener() {
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r2);
    ...
    var EditComponent = /*#__PURE__*/function () {
      ...
      function EditComponent(blogService, location, route, router) {
        var _this = this;
      ...
      _createClass(EditComponent, [{
        ...
        value: function preview() {
          ...
          var url = "/preview/".concat(this.post.postid);
        ...
        value: function save() {
          ...
          if (this.blogService.isDraftNew) {
            ...
            this.blogService.newPost(this.blogService.currentUser, this.post).then(function () {
              _this2.blogService.fetchPosts(_this2.blogService.currentUser).then(function (posts) {
                _this2.blogService.posts = posts;
                console.log("post size is: " + _this2.blogService.posts.length);
            ...
            console.log(this.post.created);
            console.log(this.post.modified);
            this.blogService.updatePost(this.blogService.currentUser, this.post).then(function () {
              _this2.blogService.fetchPosts(_this2.blogService.currentUser).then(function (posts) {
                _this2.blogService.posts = posts;
                console.log(posts[0].created);
                console.log(posts[0].modified); // 		console.log("posts size is: "+this.blogService.posts.length);
        ...
        value: function _delete() {
          ...
          this.blogService.deletePost(this.blogService.currentUser, this.post.postid).then(function () {
            _this3.blogService.fetchPosts(_this3.blogService.currentUser).then(function (posts) {
              _this3.blogService.posts = posts;
        ...
        */
        ...
        value: function getPost() {
          ...
          if (!this.post || this.post.postid != postid) {
            ...
            this.blogService.getPost(this.blogService.currentUser, postid).then(function (post) {
              _this4.post = post;
              _this4.title = _this4.post.title;
              _this4.body = _this4.post.body;
              _this4.blogService.isDraftNew = false;
            })["catch"](function (err) {
              console.log(err);
              alert("wrong postid");
    ...
    EditComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      ...
      decls: 1,
      vars: 1,
      consts: [[4, "ngIf"], ["type", "text", "placeholder", "title", 3, "ngModel", "ngModelChange"], ["type", "textarea", "placeholder", "body", 3, "ngModel", "ngModelChange"], [3, "click"]],
      ...
      directives: [_angular_common__WEBPACK_IMPORTED_MODULE_2__["NgIf"], _angular_forms__WEBPACK_IMPORTED_MODULE_4__["DefaultValueAccessor"], _angular_forms__WEBPACK_IMPORTED_MODULE_4__["NgControlStatus"], _angular_forms__WEBPACK_IMPORTED_MODULE_4__["NgModel"]],
  ...
  function srcAppListListComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    function ListComponent_li_9_Template(rf, ctx) {
      if (rf & 1) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function ListComponent_li_9_Template_li_click_0_listener() {
    ...
    var ListComponent = /*#__PURE__*/function () {
      ...
      function ListComponent(blogService, router, route) {
        ...
        this.blogService = blogService;
        this.router = router;
        this.route = route; //this.route.paramMap.subscribe(() => this.getPost());
      }
      ...
      _createClass(ListComponent, [{
        ...
        value: function getPost() {
          ...
          this.blogService.fetchPosts(this.blogService.currentUser).then( //posts => this.posts = posts
          function (posts) {
            return _this5.blogService.posts = posts;
          });
        }
      }, {
        key: "onSelect",
        value: function onSelect(post) {
          ...
          var url = "/edit/".concat(post.postid);
          this.router.navigateByUrl(url);
        }
      }, {
        key: "onNew",
        value: function onNew() {
          ...
          var _iterator = _createForOfIteratorHelper(this.blogService.posts),
              _step;
          ...
          var url = "/edit/".concat(newPost.postid);
          this.router.navigateByUrl(url);
        }
      }]);
    ...
    ListComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      ...
      decls: 10,
      vars: 1,
      consts: [[1, "blogs"], [3, "click"], ["class", "item", 3, "click", 4, "ngFor", "ngForOf"], [1, "item", 3, "click"]],
  ...
  function srcAppPreviewPreviewComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var PreviewComponent = /*#__PURE__*/function () {
      ...
      _createClass(PreviewComponent, [{
        ...
        key: "edit",
        value: function edit() {
          var url = "edit/".concat(this.post.postid);
          this.router.navigateByUrl(url);
        }
      }, {
        key: "getPost",
        value: function getPost() {
          ...
          console.log("draft: " + this.blogService.getCurrentDraft());
          this.post = this.blogService.getCurrentDraft();
          var htmlRenderer = new commonmark__WEBPACK_IMPORTED_MODULE_1__["HtmlRenderer"]();
          var parser = new commonmark__WEBPACK_IMPORTED_MODULE_1__["Parser"]();

          if (!this.post || this.post.postid != postid) {
            //direct url acess from outside
            this.blogService.getPost(this.blogService.currentUser, postid).then(function (post) {
              _this7.post = post;
              _this7.title = _this7.post.title;
              _this7.body = _this7.post.body;
              _this7.parsedBody = htmlRenderer.render(parser.parse(_this7.body));
              _this7.parsedTitle = htmlRenderer.render(parser.parse(_this7.title));
            })["catch"](function (err) {
              console.log(err);
              alert("wrong postid");
    ...
    PreviewComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      ...
      decls: 6,
      vars: 2,
      consts: [[3, "click"], [1, "title", 3, "innerHTML"], [1, "body", 3, "innerHTML"]],
      template: function PreviewComponent_Template(rf, ctx) {
        if (rf & 1) {
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "button", 0);

          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function PreviewComponent_Template_button_click_0_listener() {
            return ctx.edit();
          });
  ...
  function _(module, exports, __webpack_require__) {
    ...
    /*! /home/cs144/shared/project4/angular-blog/angular-blog/src/main.ts */
    "./src/main.ts");
    /***/
  }
}, [[0, "runtime", "vendor"]]]);
